...
echo "TODO: *** THIS IS BEING MOVED TO TERRAFORM"
...
function link_github_oidc_to_workload_pool() {
  ...
  echo "Linking provider $provider_id to workload identity pool $workload_identity_pool"
...
function main() {
  echo "Setting up workload identity for project $SEED_PROJECT and identity pool $WORKLOAD_IDENTITY_POOL"
